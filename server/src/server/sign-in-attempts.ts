...
export function assertSignInNotLocked(appId: string, identifier: string) {
...
export function recordSignInFailure(appId: string, identifier: string) {
...
export function recordSignInSuccess(appId: string, identifier: string) {
  database.prepare(
